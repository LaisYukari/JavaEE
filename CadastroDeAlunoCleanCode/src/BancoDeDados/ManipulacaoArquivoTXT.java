...
public class ManipulacaoArquivoTXT {
	...
	public static void LerArquivoTXT(List<Aluno> listaDeAlunos) throws FileNotFoundException, IOException {
		...
		try(BufferedReader reader = new BufferedReader(new FileReader(nomeDoArquivo)))  { //Para ler. Neste caso, o arquivo txt, todas as informações que estão la.
			...
			while((line = reader.readLine())!= null && !"".equals(line)) { //transformar um objeto da lista em uma linha
